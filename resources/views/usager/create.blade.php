...
<div class="content-form" >
    <form id='form_usager_personne_physique' role="form" action="{{ route('store.usager') }}" enctype="multipart/form-data" method="post" class="form-horizontal form-bordered">
        ...
        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" id="" name="numero_piece" class="form-control"  placeholder="Numéro de la Pièce d'identité .." value="{{old('numero_piece')}}" required>
                                                     ...
                                                     <fieldset style="width:100%">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <select id="code" name="nationalite_usager" data-placeholder="Choisir Nationalité" class="form-control select2" onchange="afficherPj();" style="width: 100%;" required >
                                                                    <option></option>
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <select id="code_pays" name="pays_usager" data-placeholder="Choisir votre pays de residence" class="form-control select2" style="width: 100%;" required onchange="afficherDecoupage();">
                                                                    <option></option>
                                                                        @foreach ($pays as $pay )
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="mb-3 decoupage_administratif" >
                                                                    <label class=" control-label" for="example-chosen">Région (<font color="red">*</font>)</label>
                        ...
                        <input type="reset" class="btn btn-md btn-danger" data-dismiss="modal" value="Annuler">
...
<div class="modal fade modal-front" id="modal-confirm" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <center><h3 class="modal-title text-center" id="modal-login-label">  Confirmer ques les données sont correctes <i class="fa fa-key"></i></h3></center>
                ...
                <fieldset style="width:100%">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">                            
                            <div class="mb-3">
                                  <label class="form-label" for="val_username">Profession (<font color="red">*</font>)</label>
                                    <select id="profession_conjoint" name="profession" data-placeholder="Choisir votre profession ..." class="form-control" style="width: 100%;" required>
                                       <option></option>
                                            @foreach ($professions as $profession )
                                                 <option value="{{ $profession->code }}">{{ $profession->libelle }}</option>
                                             @endforeach                                                                  
