    ...
    <div class="modal-dialog modal-lg ">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" >Modifier unebb  piece jointebb</h5>
...
<div id="modal-piece_pm" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>•	<a href="http://me.bf/fr/file/2967/download?token=kziektSF" style="color: blue">Télécharger ici la déclaration sur l'honneur</a></p>
                <p>•	<a href="http://me.bf/fr/file/2968/download?token=pI__AZKv" style="color: blue">Télécharger ici le formulaire de demande de carte professionnelle de commerçant (CPC)</a></p>
                <!-- <p>•	<a href="http://me.bf/fr/file/2893/download?token=P7jVe3E4" style="color: blue">Télécharger ici la fiche de demande de localisation</a></p> -->
                <p>•	<a href="http://me.bf/fr/file/3481/download?token=avSak-TP" style="color: blue">Télécharger ici le formulaire RCCM</a></p>
                <p>•	<a href="http://me.bf/fr/file/132/download?token=_Sx15V_e" style="color: blue">Télécharger ici le modèle d'acte de dépôt</a></p>
                <p>•	<a href="http://me.bf/fr/file/2964/download?token=a02UueF2" style="color: blue">Télécharger ici la fiche de visite</a></p>
                <p>•	<a href="http://me.bf/fr/file/3481/download?token=avSak-TP" style="color: blue">Télécharger ici le contrat d'apport de bien</a></p>
                <p>•	<a href="http://me.bf/fr/file/3481/download?token=avSak-TP" style="color: blue">Télécharger ici un exemplaire original des statuts de la société unipersonnel</a></p>
                <p>•	<a href="http://www.me.bf/fr/file/3087/download?token=pBQrGH2F" style="color: blue">Télécharger ici un exemplaire original des statuts de la société pluripersonnel</a></p>
                <p>•	<a href="http://www.me.bf/fr/file/133/download?token=wVOcjoWQ" style="color: blue">Télécharger ici un exemplaire de Procès Verbal (PV)</a></p>
                <p>•	<a href="http://me.bf/fr/file/3481/download?token=avSak-TP" style="color: blue">Télécharger ici un exemplaire de déclaration de régularité et de conformité</a></p>
   ...
   <!-- <script>
    function verifier_mot_de_passe(){
     ...
     var password= $('#password').val();
      var url = "{{ route('verifier_password') }}";
            $.ajax({
                    url: url,
                    type: 'GET',
                    ...
                    success: function (data) {
                      alert(data);
                       if(data==1){
                         $('#message_bad_passe').show();
                       }
                       else{
                        $('#message_bad_passe').hide();
                       }
                    }
            });
    }
...
<script>
 ...
 <script src=https://api.gutouch.net/touchpayv2/script/touchpaynr/prod_touchpay-0.0.1.js  type='text/javascript'>
  ...
  // function calltouchpay(numero_demande){
  //   //alert(numero_demande);
  //   var id= $('#demande_id').val();
  //   //alert(id);
  //   //alert(numero_demande);
  //   //var numero_demande=$('#'+numero_demande).val();
  //   //alert(numero_demande);
  //   var route_sucess= '{{ route("valider.paiement",":id")}}';
  //   var rout_fiche = route_sucess.replace(':id', id);
  //   var order_number=numero_demande;
  //   var agence_code='MSENT2793';
  //   var secure_code='suzYy19U3ev2TIsabnK6JtKaFG75oZjc1zD36Mc4QPgcVXRZAM';
  //   var domaine='maison.com';
  //   var url_redirection_success=rout_fiche;
