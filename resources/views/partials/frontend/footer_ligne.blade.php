      ...
      <div class="container">
        <div class="row justify-content-between">
          <div class="col-lg-4 col-md-6 footer-widget footer-about">
            ...
            <p>132, Avenue de Lyon, 11 BP OUAGADOUGOU 11, BURKINA FASO Tel: 25 39 80 60 Fax: 25 39 80 62 Email: info@me.bf</p>
          ...
          <div class="col-lg-4 col-md-6 footer-widget mt-5 mt-md-0">
            ...
            <div class="working-hours">
              ...
              Les retraits des documents (RCCM, IFU, CNSS et CPC) se font font dans les représentation
              régionales de la MEBF du Lundi au Vendredi à partir de 13h</p>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>•	Télécharger ici le formulaire de renseignement</p>
                <p>•	<a href="http://me.bf/fr/file/2967/download?token=kziektSF" style="color: blue">Télécharger ici la fiche de déclaration sur l'honneur</a></p>
                ...
                <p>•	<a href="http://me.bf/fr/file/2969/download?token=yvogbXGZ" style="color: blue">Télécharger ici la fiche de visite</a></p>
...
<div id="modal-piece_pm" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>•	Télécharger ici le formulaire de renseignement pour la création d'une société ou d'un GIE</p>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>Avant de créer votre entreprise, vous devez d'abord vérifier la disponibilité du nom commercial
                  Vous pouvez aussi réserver le nom commercial et ou la dénomination sociale choisie pour votre entreprise
                  , contre rémise d'une Attestation de Disponibilité et de Réservation qui sera jointe aux statut pour la numérisation
