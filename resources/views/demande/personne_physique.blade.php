                                                ...
                                                <section >
                                                    ...
                                                    <!-- <form> -->
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="progress-basicpill-firstname-input">Piece d'identité (<font color="red">*</font>)</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="number" min="1000000" name="chiffre_daffaire_previsionnel" class="form-control chiffre_daffaire_prev_pp" id="chiffre_daffaire_prev_pp" required> 
                                                                </div>
                                                            </div>
                                                        </div>
                                                     </fieldset><br>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select id="secteur_activite" name="secteur_activite"  class="form-control select" data-placeholder="Choisir le secteur ..." style="width: 100%;" onchange="changeActivite('secteur_activite','activite_principale');" >                                                                          
                                                                    <option></option>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <textarea type="text" name="objet_social" class="form-control" data-placeholder="Saisir les activités que vous exercez" id="objet_social" ></textarea>                                                                   
                                                                </div>
                                                            </div>
                                                            <!-- <div class="col-lg-6">
                                                                <div class="mb-3">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="number" min="0" name="employee_permanant" class="form-control" id="employee_permanant" > 
                                                                </div>
                                                                <div class="mb-3">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                ...
                                                                <label class="form-label" for="progress-basicpill-cstno-input">Région (<font color="red">*</font>)</label>                                                                    
                                                                    <select id="region_usager" name="region_entreprise" data-placeholder="Choisir la région" class="form-control select" style="width: 100%;"  onchange="changeValue('region_usager', 'province_usager', 'provinces','region_usager');" >
                                                                        <option></option>
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <!-- <input type="text" name="cst" class="form-control" id="progress-basicpill-cstno-input"> -->
                                                                    <label class="form-label" for="progress-basicpill-cstno-input">Province (<font color="red">*</font>)</label>                                                                    
                                                                    <select id="province_usager" name="province_entreprise" data-placeholder="Choisir la province" class="form-control select" style="width: 100%;"   onchange="changeValue('province_usager', 'commune_usager', 'communes','region_usager');" >
                                                                        <option></option>                                                                     
                                                                    </select>                                                                    
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label class="form-label" for="progress-basicpill-cstno-input">Commune ou Département (<font color="red">*</font>)</label>                                                                    
                                                                    <select id="commune_usager" name="commune_entreprise" data-placeholder="Choisir la commune" class="form-control select" style="width: 100%;"   onchange="changeValue('commune_usager', 'arrondissement_usager', 'arrondissements','province_usager');" >
                                                                        <option></option>
                                                                    </select>                                                                    
                                                                </div>
                                                                <div class="mb-3">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select id="secteur_usager" name="secteur_entreprise" data-placeholder="Choisir le Secteur ou Village" class="form-control select" style="width: 100%;" >
                                                                        <option> -- Selectionner --</option>
                                                                    </select>                                                                    
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" name="mobile_1" class="form-control" id="mobile_pp" >
                                                                </div>
                                                                <div class="mb-3">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" name="email" class="form-control" id="progress-basicpill-cstno-input" >
                                                                </div>
                                                                <div class="mb-3">
                                                     ...
                                                     <fieldset>
                                                        ...
                                                        <div class="row">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        ...
                                                                        <select id="usage" name="usage" data-placeholder="Choisir l'usage" class="form-control select" style="width: 100%;" >
                                                                            <option></option>
