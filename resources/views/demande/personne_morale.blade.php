                                                ...
                                                <section class="tab-pane" id="progress-seller-detailss">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        @endforeach
                                                                ...
                                                                @if(returnpieceinfos('statut'))
                                                                    <div class="input-group" >
                                                                        <input type="text" name="statut" id="statut_input" disabled class="form-control col-md-7 statut_input piece_statut"  value="staut" >
                                                                         <div class="col-md-5">
                                                                        <a href="#updatepiecejointe" id="statut_edit"  data-toggle="modal"  class="btn btn-md btn-success statut" onclick="editpiecejointe('statut')"> <i class="fas fa-pen"></i> </a>
                                                                        <a href="{{ route('detaildocument') }}?categoriepiece=statut"  id="statut_view"   class="btn btn-md btn-success statut_view"> <i class="fas fa-eye"></i> </a>
                                                                        </div>
                                                                    </div>
                                                                @else
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="progress-basicpill-firstname-input">Titre de Propriété/Jouissance</label>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group formulaire_cpc_es_group_edit" style="display: none">
                                                                        <input type="text" name="formulaire_cpc_es" id="formulaire_cpc_es" disabled class="form-control col-md-7 formulaire_cpc_es_input"  value="Formulaire de demande CPC" >
                                                                         <div class="col-md-5">
                                                                            <a href="#updatepiecejointe" id="formulaire_cpc_es_edit" data-toggle="modal"  class="btn btn-md btn-success formulaire_cpc_es" onclick="editpiecejointe('formulaire_cpc_es')"> <i class="fas fa-pen"></i> </a>
                                                ...
                                                <div>
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" id="nom_commercial_pm" name="nom_commercial" class="form-control"  onchange="valider_nom_commercial('nom_commercial_pm');" >
                                                                    <!--  -->
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" id="denomination_sociale_pm" name="denomination_sociale" class="form-control"  onchange="valider_nom_commercial('denomination_sociale_pm');" >
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select id="type_etablissement_pm" name="type_etablissement" data-placeholder="Choisir le type d'établissement ..." class="form-control select" style="width: 100%;" >
                                                                        <option></option>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="number" min="0" name="chiffre_daffaire_previsionnel" class="form-control" id="chiffre_daffaire_prev_pm" onchange="chiffre_daffaire();" > 
                                                                </div>
                                                            </div>
                                                        </div>
                                                     </fieldset><br>
                                                     <fieldset>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                            <p>choisir en premier le secteur d'activité</p>
                                                                <div class="mb-3">
                                                                    <label class="form-label" for="progress-basicpill-cstno-input">Secteur d'activité (<font color="red">*</font>)</label>
                                                                    <select id="secteur_activite_pm" name="secteur_activite" data-placeholder="Choisir l'activité ..." class="form-control select" onchange="changeActivite('secteur_activite_pm','activite_principale_pm');" style="width: 100%;" >
                                                                            <option></option>   
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    <label class="form-label" for="progress-basicpill-vatno-input">Activité Principale (<font color="red">*</font>)</label>
                                                                        <select id="activite_principale_pm" name="activite_principale" data-placeholder="Choisir l'activité ..." class="form-control select" style="width: 100%;" >
                                                                            <option></option>                                                                           
                                                                        </select>                                                           
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <textarea type="text" name="objet_social" class="form-control" data-placeholder="Saisir les activités que vous exercez" id="objet_social_pm" ></textarea>                                                                   
                                                                </div>
                                                            </div>
                                                            <!-- <div class="col-lg-6">
                                                                <div class="mb-3">
                                                        ...
                                                        <div class="row">                                                            
                                                            <div class="col-lg-4">
                                                                ...
                                                                <label class="form-label" for="progress-basicpill-vatno-input">Dont Numéraire</label>
                                                                    <input type="number" name="capital_en_numeraire" class="form-control" id="dont_numeraire" onchange="montantCapital();">
                                                                </div>
                                                            </div>
                                                            <!-- <div class="col-lg-3">
                                                                <div class="mb-3">
                                                            ...
                                                            <div class="col-lg-4"> 
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="number" name="capital_en_nature" class="form-control" id="dont_nature" onchange="montantCapital();">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <div class="mb-3">
                                                        ...
                                                        <div class="row">                                                        
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="number" name="montant_action" class="form-control" id="montant_action" onchange="montantAction();">
                                                                </div>
                                                            </div>  
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    <label class="form-label" for="progress-basicpill-vatno-input">Nombre d'Actions ou De Parts Sociales</label>
                                                                    <input type="number" name="nombre_action" min="0" class="form-control" style="pointer-events: none;" id="nbre_action">
                                                                </div>
                                                            </div>                                    
                                                        </div>
                                                     </fieldset> <br>                                                     
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="number" name="employee_permanant" min="0" class="form-control" id="employee_permanant_pm" > 
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label class="form-label" for="progress-basicpill-cstno-input">Temporaire</label>                                                                    
                                                                    <input type="number" name="employee_temporaire" min="0" class="form-control" id="progress-basicpill-cstno-input"> 
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    <label class="form-label" for="progress-basicpill-cstno-input">Etranger</label>                                                                    
                                                                    <input type="number" name="employee_etranger" min="0" class="form-control" id="progress-basicpill-cstno-input"> 
                                                                </div>
                                                            </div>
                                                        </div>
                                                     </fieldset><br>
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select id="qualite_commissaire1" name="qualite_commissaire[]" data-placeholder="Choisir la qualite ..." class="form-control select" style="width: 100%;" >                                                                                                                                                       
                                                                                <option value="1" Selected>Titulaire</option>                                                                                                                                                          
                                                                    </select>                                                                    
                                                                </div>                                                            
                                                            </div>                                                 
                                                         </div>
                                                            ...
                                                            <div class="col-lg-5">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select id="qualite_commissaire2" name="qualite_commissaire[]" data-placeholder="Choisir la qualité ..." class="form-control select" style="width: 100%;">                                                                                                                                                         
                                                                                <option value="2" selected>Supléant</option>                                                                                                                                                         
                                                                    </select>                                                                    
                                                                </div>                                                            
                                                            </div>                                                 
                                                         </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select id="region_entreprise" name="region_entreprise" data-placeholder="Choisir la région" class="form-control select" style="width: 100%;"  onchange="changeValue('region_entreprise', 'province_entreprise', 'provinces','region_entreprise');" >
                                                                        <option></option>
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select id="province_entreprise" name="province_entreprise" data-placeholder="Choisir la province" class="form-control select" style="width: 100%;"   onchange="changeValue('province_entreprise', 'commune_entreprise', 'communes','region_entreprise');" >
                                                                        <option></option>                                                                     
                                                                    </select>                                                                    
                                                                </div>
                                                                <div class="mb-3">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select id="arrondissement_entreprise" name="arrondissement_entreprise" data-placeholder="Choisir l'arrondissement" class="form-control select" style="width: 100%;"  onchange="changeValue('arrondissement_entreprise', 'secteur_entreprise', 'secteur_villages','commune_entreprise');"  >
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select id="secteur_entreprise" name="secteur_entreprise" data-placeholder="Choisir le Secteur ou Village" class="form-control select" style="width: 100%;" >
                                                                        <option> -- Selectionner --</option>
                                                                    </select>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" name="mobile_1" class="form-control" id="mobile_pm" >
                                                                </div>
                                                                <div class="mb-3">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" name="email" class="form-control" placeholder="exempl@gmail.com" id="progress-basicpill-cstno-input" >
                                                                </div>
                                                                <div class="mb-3">
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="row">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        ...
                                                                        <select id="usage_terrain" name="usage" data-placeholder="Choisir l'usage" class="form-control select" style="width: 100%;" >
                                                                            <option></option>
                                                          ...
                                                          <div class="row">
                                                              <div class="col-lg-12">
                                                                  ...
                                                                  <label class="confirme">Je certifie que les documents joints sont authentiques (absence de faux et usage de faux)
                                                                        ...
                                                                        <input type="checkbox" name="checkox" id="confirmation_pm"><span class="checkmark"></span>
                                                                   </label>                                                                     
                                                                  </div>
