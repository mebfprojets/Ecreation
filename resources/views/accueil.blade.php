...
<div class="col-md-3 col-sm-6" >
                <div class="service text-center">
                    ...
                    <p>
                        ...
                        <a class="btn btn-success btn-block"  href="http://www.me.bf/fr/file/134/download?token=DqQCiCeH">Formulaire de renseignement</a>
...
<div class="col-md-3 col-sm-6">
                <div class="service text-center">
                    ...
                    <p>
                        ...
                        <a class="btn btn-success btn-block"  href="http://www.me.bf/fr/file/3977/download?token=PZazTV3p">Formulaire de renseignement</a>
    ...
    <div class="row" style="margin-top:30px;">
        ...
        <div class="col-md-4 col-sm-5" >
                <div class="service text-center">
                    ...
                    <p class="montant" style="margin-bottom:-20px; font-weight:700;font-size: 21px;">45.000 FCFA</p><hr>
        ...
        <div class="col-md-4 col-sm-6" >
                <div class="service text-center">
                    ...
                    <p style="margin-top: -20px; font-weight:700;font-size: 21px; margin-bottom:-20px;">RCCM + IFU + CNSS : 53.500 F CFA</p><hr>
